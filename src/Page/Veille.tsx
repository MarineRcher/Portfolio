...
function Veille() {
    return(
        <>
           ...
           <p>qui vont venir encoder les caractères. Ces fonctions encodent tous les caractères spéciaux (", des balises) mais aussi les caractères accentués (é, è, à, ù, etc.). Cependant, </p>
           <img src={solutionXss1} />

           <p>
           encode également les simples guillemets, ce qui peut être problématique si vous utilisez la chaîne vulnérable dans un attribut d'une balise HTML qui est sous la forme 
           </p>
           ...
           vous pouvez utiliser la méthode
            ...
            En fonction de ce qu’il doit être renseigné, limiter les entrée avec maxlenght() et minlenght() et autorisé seulement les characteres dont l’utilisateur va avoir besoin avec addEventListener().<br/>
            ...
            <p>
            Pour commencer, un identifiant unique pour les utilisateurs qui se connectent est important afin qu’ils soient d’autant plus difficile à trouver.<br/>
            ...
            <p>Afin d’éviter des incidents liés au contrôle d’accès défaillants il est important d’attribuer un rôle et de bien séparer en fonctions des droits liés au rôle. <br/>
                Il faut régulièrement vérifier si l’utilisateur à les droits d’accès en fonctions des actions qu’il fait.
            </p>
            <img src={solutionDefaillant4} />

            <h3>Conclusion</h3>
            <p>
            En conclusion, la sécurité des applications web est un enjeu majeur pour les professionnels de l'IT et nécessite une attention constante. <br/>
            Les failles telles que les injections SQL, le Cross-Site Scripting et les contrôles d'accès défaillants représentent des risques significatifs pour l'intégrité des systèmes d'information. <br/>
            Heureusement, des solutions existent pour mitiger ces risques, telles que l'utilisation de requêtes paramétrées, le filtrage des entrées et sorties, et l'implémentation de politiques de sécurité strictes.<br/>
            </p>
